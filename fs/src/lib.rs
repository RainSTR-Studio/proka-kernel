...
impl<B: BlockDevice> FileSystem<B> {
    ...
    pub fn get_max_inode(&self) -> usize {
        ((self.data_start_block - 1) as usize * self.super_block.block_size as usize) / core::mem::size_of::<definition::Inode>()
    }
    ...
    fn alloc_inode(&mut self, file_type: definition::FileType) -> Result<(Inode, u32), &'static str> {
    ...
    /// # Exa
    fn convert_name(name_src: &[u8]) -> [u8; 256] {
